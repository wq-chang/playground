// Package ktype holds canonical type definitions shared between the public
// kafka package and its internal/consumer collaborators. It is a leaf package
// with no dependencies on go-services/library/kafka, preventing import cycles.
//
// The public kafka package aliases these types so end users write
// kafka.Subscription, kafka.AckMode, etc. — the ktype package is an
